                ...
                if (manager instanceof LinearLayoutManager) {
                    ...
                    if (recyclerView.getChildCount() > 0) {
                        ...
                        if (firstVisibleChild != null && firstVisibleChild.getMeasuredHeight() >= recyclerView.getMeasuredHeight()) {
                            return recyclerView.getScrollY() <= 0 && recyclerView.canScrollVertically(-1);
                        }
                        View firstChild = recyclerView.getChildAt(0);
                        RecyclerView.LayoutParams childParams = (RecyclerView.LayoutParams) firstChild.getLayoutParams();
                        firstChildTop = firstChild.getTop() - childParams.topMargin - getRecyclerViewItemTopInset(childParams) - recyclerView.getPaddingTop();
                    }
