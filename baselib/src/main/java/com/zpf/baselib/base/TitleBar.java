...
import com.zpf.baselib.interfaces.TitleBarInterface;
import com.zpf.baselib.ui.IconTextView;

/**
 * Created by ZPF on 2018/6/14.
 */
public class TitleBar extends CardView implements TitleBarInterface {
    ...
    public TitleBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        RelativeLayout.LayoutParams titleLayoutParams = new RelativeLayout.LayoutParams(titleLayoutWidth,
        ...
        RelativeLayout.LayoutParams rightLayoutParams = new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.WRAP_CONTENT,
                RelativeLayout.LayoutParams.MATCH_PARENT);
        ...
        addView(rootLayout);
        this.setCardElevation(4 * metrics.density);
    }
