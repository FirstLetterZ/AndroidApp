...
import com.zpf.baselib.base.BaseActivity;
import com.zpf.baselib.base.BaseFragment;
...
public class PhotoUtil {
    ...
    public static boolean takePhoto(ViewContainerInterface viewContainer, String filePath, int requestCode) {
        if (viewContainer != null) {
            if (viewContainer instanceof BaseFragment) {
                return takePhoto(((Fragment) viewContainer), filePath, requestCode);
            } else if (viewContainer instanceof BaseActivity) {
