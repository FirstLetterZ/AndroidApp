...
CacheMap {
    ...
    public static Editor edit() {
        return new Editor() {
            ...
            public Editor putValues(int key, Object value) {
                ...
                if (key > 0) {
                    editor = SpUtil.putValues(editor, AppConst.CACHE_SP_KEY + key, value);
                }
                return this;
            }
    ...
    public static <T> List<T> getArray(int key, @NonNull Class<T> cls) {
        ...
        if (value == null) {
            String jsonString = SpUtil.getString(AppConst.CACHE_SP_KEY + key);
    ...
    private static boolean isDefaultValue(Object o) {
        if (o == null) {
            ...
            return AppConst.DEF_STRING.equals(o);
        } else if (o instanceof Integer) {
            return AppConst.DEF_INT == (int) o;
        } else if (o instanceof Double) {
            return AppConst.DEF_DOUBLE == (double) o;
        } else if (o instanceof Long) {
            return AppConst.DEF_LONG == (long) o;
        } else if (o instanceof Float) {
            return AppConst.DEF_FLOAT == (float) o;
        } else {
            return o instanceof Boolean && AppConst.DEF_BOOLEAN == (boolean) o;
        }
    }
